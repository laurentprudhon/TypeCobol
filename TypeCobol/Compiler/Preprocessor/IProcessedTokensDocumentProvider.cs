...
namespace TypeCobol.Compiler.Preprocessor
{
    ...
    public interface IProcessedTokensDocumentProvider
    {
        ...
        ProcessedTokensDocument GetProcessedTokensDocument(string libraryName, string textName, MultilineScanState scanState, out PerfStatsForImportedDocument perfStats);
    }
